...
- [x] **스토어 검색 노출 개선 — 앱 이름에 부제 추가**: "Don't Touch My Phone"이 흔한 도난방지 앱 카테고리 이름이라 정확 검색에서도 노출이 밀리는 문제 대응. Play 앱 이름 글자수 제한(30자) 안에서 3개 언어 모두 부제 추가: EN `Don't Touch My Phone: Alarm`(27자), KO `Don't Touch My Phone: 도난방지`(26자), ES `Don't Touch My Phone: Alarma`(28자). 이미 진행 중이던 v4 심사에 함께 제출하면 심사가 취소되고 처음부터 재시작된다는 경고가 떴으나(8/31 기한까지 여유 있어 문제없다고 판단), 사용자 확인 후 함께 제출 진행.
